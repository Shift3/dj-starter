...
if REST_FRAMEWORK['DEFAULT_RENDERER_CLASSES'] is not None:
    ...
    if 'djangorestframework_camel_case.render.CamelCaseBrowsableAPIRenderer' in REST_FRAMEWORK['DEFAULT_RENDERER_CLASSES']:
        REST_FRAMEWORK['DEFAULT_RENDERER_CLASSES'].remove('djangorestframework_camel_case.render.CamelCaseBrowsableAPIRenderer')
